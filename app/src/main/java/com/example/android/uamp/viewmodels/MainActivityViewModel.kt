...
class MainActivityViewModel(
    ...
    private val _rootMediaId = MediatorLiveData<String?>()
    val rootMediaId: LiveData<String?> get() = _rootMediaId

    init {
        _rootMediaId.addSource(musicServiceConnection.isConnected) { isConnected ->
            _rootMediaId.value = if (isConnected) {
