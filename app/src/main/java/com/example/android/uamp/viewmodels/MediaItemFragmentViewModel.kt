...
class MediaItemFragmentViewModel(
     ...
     */
    private val _networkError = MediatorLiveData<Boolean>()
    val networkError: LiveData<Boolean> get() = _networkError

    init {
        _networkError.addSource(musicServiceConnection.networkFailure) { failure ->
            _networkError.value = failure
        }
    }
    ...
    class Factory(
        ...
        override fun <T : ViewModel> create(modelClass: Class<T>): T {
            if (modelClass.isAssignableFrom(MediaItemFragmentViewModel::class.java)) {
